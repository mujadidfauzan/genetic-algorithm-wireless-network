...
map_path = "../Data-Penduduk-SBY/maping.csv"
...
if __name__ == "__main__":
    ...
    print(
        f"map size= {map_size}, max needed BW= {max_BW}, population sum = {pop_sum}, recomb_prob= {recomb_prob}, mut_prob= {mut_prob}"
    )
    ea = EA(
        n_iter,
        mut_prob,
    ...
    print(
        f"best found answer has {best_ans} fitness, {best_towers} towers, {best_ans_price} price and {best_ans_satisfaction} user satisfaction"
    )
    histories = np.array(histories)
    np.savetxt("histories.csv", histories, delimiter=",")
